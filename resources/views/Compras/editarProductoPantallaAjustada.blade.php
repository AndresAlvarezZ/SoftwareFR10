...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h3><b><center>Procesar Solicitud <a id="ajuste" href="/ajuste">Cerrar ventana</a></center></b></h3>
        </div>

        <div class="card-body">

            <form action="/editarProductoPantallaAjustada/{{$producto->id}}" method="POST">
                @csrf
                @method ('put')
                ...
                <div class="row ">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="number" class="form-control" readonly  name="precioDelProducto" value="{{$producto->precioDelProducto}}"/> <br>
            ...
            <form action="/eliminarProductoPantallaAjustada/{{$producto->id}}" method="post">
              @csrf
              @method('delete')
              <center><button type="submit" class="btn-danger">Eliminar producto</button></center>
            </form>
        </div>
    </div>
</div>
