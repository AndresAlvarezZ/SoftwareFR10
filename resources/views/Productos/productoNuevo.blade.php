              ...
              <div id="ingresarProveedor" class="card-body">
                ...
                <form action="/ingresarProducto" method="post">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="nombreDelProducto" type="text" class="form-control @error('nombreDelProducto') is-invalid @enderror" name="nombreDelProducto" value="{{ old('nombreDelProducto') }}" required autocomplete="nombreDelProducto" autofocus>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input id="codigoDelProducto"  type="text" class="form-control @error('codigoDelProducto') is-invalid @enderror" name="codigoDelProducto" value="{{ old('codigoDelProducto') }}" required autocomplete="nombreDelProducto" autofocus>
