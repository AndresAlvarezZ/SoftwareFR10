...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                <div id="cabeza" class="card-header"><h1>Registro de usuarios</h1></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="apellido" placeholder="Apellido" type="text" class="form-control @error('apellido') is-invalid @enderror" name="apellido" value="{{ old('apellido') }}" required autocomplete="apellido" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="dni" placeholder="Cédula" type="number" min="9" class="form-control @error('dni') is-invalid @enderror" name="dni" value="{{ old('dni') }}" required autocomplete="dni" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="clave" placeholder="Clave de acceso" type="password" class="form-control @error('clave') is-invalid @enderror" name="clave" value="{{ old('clave') }}" required autocomplete="clave" autofocus>
